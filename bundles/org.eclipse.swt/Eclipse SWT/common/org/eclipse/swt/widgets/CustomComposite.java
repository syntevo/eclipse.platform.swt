...
public abstract class CustomComposite extends Composite {
	...
	public final Color getBackground() {
		return background != null ? background : display.getSystemColor(SWT.COLOR_LIST_BACKGROUND);
	}
	...
	public final Color getForeground() {
		return foreground != null ? foreground : display.getSystemColor(SWT.COLOR_LIST_FOREGROUND);
	}
